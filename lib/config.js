...
const OLD_GLOBAL_CONFIG = path.join(HOME, '.cursor', 'skilltags-categories.conf');
const OLD_PROJECT_CONFIG = path.join(process.cwd(), '.cursor', 'skilltags-categories.conf');
